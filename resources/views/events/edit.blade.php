...
<div id="event-create-container" class="col-md-6 offset-md-3">
    ...
    <form action="/events/update/{{$event->id}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" class="form-control" placeholder="Descricao">{{$event->description}}</textarea>
        </div>
        <div class="form-group">
            ...
            <div class="form-group">
                <input type="checkbox" name="items[]" id="" value="Cerveja gratis"> Cerveja gratis
            </div>
            <div class="form-group">
